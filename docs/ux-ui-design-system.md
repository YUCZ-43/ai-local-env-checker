...
v0.9.0-alpha.1 introduces a stronger product-grade desktop visual system and matching static website preview for a safe local AI development setup assistant.
...
- Premium open-source AI infrastructure product.
...
- Active language controls are limited to English and Simplified Chinese for v0.9.0-alpha.1. Existing Traditional Chinese locale files are preserved but hidden from active controls.
